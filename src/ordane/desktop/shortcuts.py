...
KEYS = (
    Key("<Control>1", "win.page::overview", "Go to Overview", "Move around"),
    ...
    Key("<Control>f", "win.find", "Find an action", "Do something"),
    Key("Escape", "win.back", "Clear the search", "Do something"),
